...
<div class="row marketing">
	<div class="col-lg-12">
		<h4>Historique</h4>
		<p>PhpMyNewsletter a été créé en 2000 (première release publique le 5 juin 2000) par <a href="http://gregory.kokanosky.free.fr/v4/phpmynewsletter/" target="_blank" title="le 1er portail PhpMyNewsLetter">Grégory Kokanosky</a>. 
...
<footer class="footer">
	<p><a href="https://www.phpmynewsletter.com" target="_blank">&copy; 2014-<?php echo date('Y'); ?> PhpMyNewsLetter v.<?php echo $pmnl_version;?></a></p>
</footer>
