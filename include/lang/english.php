...
$lang_array=array (
"LN"=>"en",
"I18N_LNG"=>"en_US", // https://cdnjs.com/libraries/bootstrap-select
"OK_BTN"=>"OK",
"YES"=>"Yes",
"NO"=>"No",
"BACK"=>"Back",
...
"RESTORE"=>"Restore",
"RUNNING_TEST"=>"test in process",
"RUNNING_LIST"=>"Current list",
...
"MAIL_FOR_BOUNCE"=>"Email for bounce",
...
"CLICK_STOP_SEND"=>"Stop to send",
// Gestion des expéditeurs :
"SENDERS_MANAGEMENT"=>"Senders management",	
// ARCHIVE
...
"LAST_SEND_MAILS"=>"Last emails sent",
...
"GCONFIG_DB_TABLE_SENDERS"=>"Table of senders",
...
"GCONFIG_TIMER_CROM_TIMER_AJAX"=>"Ajax timing and sending for scheduled tasks",
"GCONFIG_TIME_FOR_EACH_SEND"=>"Seconds between each mail. Recommended : 3",
"GCONFIG_SMTP_CONFIGURATION"=>"Default SMTP configuration",
"GCONFIG_DATABASE_BACKUPS"=>"Database backups",
"GCONFIG_NUMBER_BACKUPS"=>"Number of backups to keep",
...
"GCONFIG_SUBSCRIPTION_TITLE"=>"Registrations",
...
"GCONFIG_ALERT_SUB"=>"Be notified of new listings ?",
...
"GCONFIG_DKIM_SPF_DMARC"=>"DKIM, SPF and DMARC",
"GCONFIG_DKIM_TITLE"=>"Configuration of DKIM, SPF and DMARC records",
"GCONFIG_DKIM_SELECTOR"=>"DKIM key selector",
"GCONFIG_DKIM_EXPLAIN"=>"The selector is the value before the \"._domainkey\", example: <b>default</b>._domainkey.yoursite.com",
"GCONFIG_DKIM_TEST"=>"Test the keys",
...
"UNSUBSCRIPTION_UNKNOWN_EMAIL_ADDRESS"=>"Error: unknown or already unsubscribed email address",
...
"ADMIN_MANAGEMENTS"=>"Administrator management",
"ADMINISTRATION"=>"Administration",
"MANAGEMENT_GLOBAL"=>"Global configuration of PhpMyNewsLetter parameters",
"MANAGEMENT_USERS"=>"Management of users of PhpMyNewsLetter and their rights",
"MANAGEMENT_SENDERS"=>"Management of newsletter sender accounts",
"MANAGEMENT_SMTP"=>"Management of SMTP servers used in SMTP load balancing",
"MANAGEMENT_BACKUP"=>"Managing backups of the PhpMyNewsLetter database",
"MANAGEMENT_TASKS"=>"Management of all scheduled tasks",
"ALL_STATS"=>"General statistics, all lists combined",
...
"CREATION_NEW_LIST"=>"Create a new list",
...
"SUPPORT_FORUM"=>"PhpMyNewsLetter support forum",
"ABOUT_PHPMYNEWSLETTER"=>"A little more about PhpMyNewsLetter",
"WRITING"=>"Writing",
...
"OPENED_BY_DOMAINS"=>"Opening by domain",
"CLICK_BY_HOURS"=>"Clicks by hour",
"OPEN_BY_HOURS"=>"Opening by hours",
// UPLOAD
...
"LIST_EMPTY"=>"Empty",
"LIST_MANAGE"=>"Manage",
"LIST_STATS"=>"List Statistics",
"LIST_UNSUB"=>"Unsubscribe emails",
"LIST_NUMBER"=>"List N°.",
"LIST_NAME"=>"Name",
...
"LIST_CLASSIC_WRITING"=>"Writing with the classical composer",
...
"WARNING_EMPTY_LIST"=>"Clear this list (This action is irreversible)",
"WARNING_STOP_SEND"=>"Stop now the current campaign",
"LIST_ACCES_ARCHIVES"=>"Access to archived mailings from the list, drafting from an existing archive",
"LIST_TASKS"=>"List of scheduled shipments from the list",
"LIST_BOUNCE"=>"Analysis of returns and processing of bounce mails",
"LIST_MAILS_ERROR"=>"Mails in error, manage these emails",
"LIST_EMPTY_LIST"=>"Clear this list ?",
"LIST_NEWSLETTER_CONFIGURATION"=>"Configure the newsletter of this list",
"LIST_NO_SENDING_PROCESS"=>"No sending in progress",
// Mailq
...
"SCHEDULE_EXPLAIN"=>"<p>You will plan the sending of the campaign entitled: <b>%s</b><br>
...
"SCHEDULE_MONTHS_OPTION"=>"<option value=1>January</option><option value=2>February</option><option value=3>March</option><option value=4>April</option><option value=5>May</option><option value=6>June</option><option value=7>July</option><option value=8>August</option><option value=9>September</option><option value=10>October</option><option value=11>November</option><option value=12>December</option>",
"SCHEDULE_RESULT"=>"<h4>As defined, sending the campaign :<br>\"<i>%s</i>\"<br>will be held on <span id = 'dd'>1</span><span id = 'dmo'>January</span> <span id = 'dh'>00</span>h <span id = 'dmi'>00</span>min</h4>",
...
"OPEN_DETAILLED_CAMPAIN"=>"Campaign read statistics",
"BY_TOWN"=>"by town",
...
"USERS_CHOICE_ERROR"=>"Error choosing which account to modify",
"USERS_CHOICE_ERROR_FINDING"=>"Error finding the account to modify",
"USERS_CHOICE_LIST_USERS"=>"Display the list of user accounts",
"USERS_LIST"=>"Users list",
"USERS_ADD_USER"=>"Add and configure a user account",
"USERS_ADD_A_USER"=>"Add user account",
"USERS_MODIFY_ACCOUNT"=>"Modification of a user account",
/* PROFILS */
"ID"=>"ID",
"EMAIL"=>"emaill",
"FIRST_CAMPAIGN_SEND"=>"first read campaign",
"LAST_CAMPAIGN_SEND"=>"last campaign sent",
"LAST_CAMPAIGN_OPEN"=>"last campaign read",
"COUNT_CAMPAIGNS_OPEN"=>"read campaigns",
"COUNT_CLICK"=>"total cliks",
"PROFIL"=>"profile",
"NO_OPEN"=>"no reading",
"OPENER_READER"=>"regular reader",
"MIDDLE_READER"=>"occasional reader",
"SOME_READ"=>"few reads",
"SMALL_READ"=>"rare reads",
"OPENER_CLICKER"=>"regular clicker",
"MIDDLE_CLICKER"=>"occasionnal clicker",
"SOME_CLICKS"=>"few clicks",
"SMALL_CLICKS"=>"rare clicks",
"RATIO_CLICKER"=>"% clicks",
"RATIO_READER"=>"% read",
"WAITING_FOR_MORE_STATS"=>"waiting for campaigns",
"COUNT_CAMPAIGNS_TOTAL"=>"campaigns sent",
// editeur
"WYSIWYG_EDITOR"=>"Writing WYSIWYG",
"CLEAR"=>"NEW",
"SAVE"=>"Save",
"BACKGROUND"=>"Background color",
"CLEAR_AND_CREATE_NEW"=>"Clear and create a new message",
"CONTINUE_TO_CREATE_YOUR_DOC"=>"Next step to create a mail",
"HELP_TO_CREATE"=>"Help to create a WYSIWYG message",
// LOG ACTIONS
"LOG_SELECT"=>"selected the list"
);
