...
"CLICK_STOP_SEND"=>"Stopper l'envoi",
...
"GCONFIG_DB_TABLE_SENDERS"=>"Table des expéditeurs",
...
"GCONFIG_SMTP_CONFIGURATION"=>"Configuration SMTP par défaut",
"GCONFIG_DATABASE_BACKUPS"=>"Sauvegardes de la base de données",
"GCONFIG_NUMBER_BACKUPS"=>"Nombre de sauvegardes à conserver",
...
"GCONFIG_DKIM_SPF_DMARC"=>"DKIM, SPF et DMARC",
"GCONFIG_DKIM_TITLE"=>"Configuration des enregistrements DKIM, SPF et DMARC",
"GCONFIG_DKIM_SELECTOR"=>"Sélecteur de clé DKIM",
"GCONFIG_DKIM_EXPLAIN"=>"Le sélecteur est la valeur avant le \"._domainkey\", exemple : <b>default</b>._domainkey.votresite.com",
"GCONFIG_DKIM_TEST"=>"Tester les clés",
...
"SHARED_SERVER"=>"serveur mutualisé ou partagé",
...
"UNSUBSCRIPTION_UNKNOWN_EMAIL_ADDRESS"=>"Erreur: adresse électronique inconnue ou déjà désinscrite",
...
"ADMIN_MANAGEMENTS"=>"Les gestions de l\'administrateur",
"ADMINISTRATION"=>"Administration",
"MANAGEMENT_GLOBAL"=>"Configuration globale des paramètres de PhpMyNewsLetter",
"MANAGEMENT_USERS"=>"Gestion des utilisateurs du système PhpMyNewsLetter et de leurs droits",
"MANAGEMENT_SENDERS"=>"Gestion des utilisateurs du système PhpMyNewsLetter et de leurs droits",
"MANAGEMENT_SMTP"=>"Gestion des serveurs SMTP utilisés en load balancing SMTP",
"MANAGEMENT_BACKUP"=>"Gestion des sauvegardes de la base de données PhpMyNewsLetter",
"MANAGEMENT_TASKS"=>"Gestion de toutes les tâches planifiées",
"ALL_STATS"=>"Statistiques générales, toutes listes confondues",
...
"SUPPORT_FORUM"=>"Forum de support PhpMyNewsLetter",
"ABOUT_PHPMYNEWSLETTER"=>"Un peu plus à propos de PhpMyNewsLetter",
"WRITING"=>"Rédaction",
...
"UPLOAD_ADD"=>"Ajout de pièces jointes",
// add attachment
...
"LIST_EMPTY"=>"Vider",
"LIST_MANAGE"=>"Gérer",
"LIST_STATS"=>"Statistiques de la liste",
"LIST_UNSUB"=>"Mails en désinscription",
"LIST_NUMBER"=>"Liste N°",
"LIST_NAME"=>"Nom",
...
"LIST_CLASSIC_WRITING"=>"Rédaction avec le composeur classique",
...
"LIST_ACCES_ARCHIVES"=>"Accès aux envois archivé de la liste, rédaction à partir d'une archive existante",
"LIST_TASKS"=>"Liste des envois planifiés de la liste",
"LIST_BOUNCE"=>"Analyse des retours et traitements des mails en bounce",
"LIST_MAILS_ERROR"=>"Mails en erreur, gérer ces mails",
"LIST_EMPTY_LIST"=>"Vider cette liste ?",
"LIST_NEWSLETTER_CONFIGURATION"=>"Configurer la newsletter de cette liste",
"LIST_NO_SENDING_PROCESS"=>"Pas d'envoi en cours",
// MAILQ
...
"SCHEDULE_DATE_HEAD"=>"<th>Jour du mois</th><th>Mois</th><th>Année</th><th>Heure(s)</th><th>Minute(s)</th><th>Liste</th><th>Résumé</th><th>Action</th>",
"SCHEDULE_MONTHS_OPTION"=>"<option value=1>Janvier</option><option value=2>Février</option><option value=3>Mars</option><option value=4>Avril</option><option value=5>Mai</option><option value=6>Juin</option><option value=7>Juillet</option><option value=8>Août</option><option value=9>Septembre</option><option value=10>Octobre</option><option value=11>Novembre</option><option value=12>Décembre</option>",
"SCHEDULE_RESULT"=>"Tel que défini, l'envoi de la campagne :<br>\"<i>%s</i>\"<br>commencera le <b><span id='dd'>01</span>/<span id='dmo'>01</span>/<span id='dy'>" . date('Y') . "</span> à <span id='dh'>00</span>h<span id='dmi'>00</span>min</b>",
...
"USERS_CHOICE_ERROR"=>"Erreur sur le choix du compte à modifier",
"USERS_CHOICE_ERROR_FINDING"=>"Erreur sur recherche du compte à modifier",
"USERS_CHOICE_LIST_USERS"=>"Afficher la liste des comptes utilisateurs",
"USERS_LIST"=>"Liste des utilisateurs",
"USERS_ADD_USER"=>"Ajouter et paramétrer un compte utilisateur",
/* PROFILS */
"ID"=>"ID",
"EMAIL"=>"adresse mail",
...
// LOG ACTIONS
"LOG_SELECT"=>"a sélectionné la liste"
);
