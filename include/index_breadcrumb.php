        <article class="breadcrumbs"><a href="?page=listes&token=<?php echo $token;?>&l=l"><?php echo tr("ADMINISTRATION");?></a>
            ...
            if($page == "profils"){
                echo '<div class="breadcrumb_divider"></div> <a class="current">'.tr("MENU_SUBSCRIBERS").'</a>';
                echo '<div class="breadcrumb_divider"></div> <a class="current">'.tr("SUBSCRIBER_PROFILS").'</a>';
            }
            ...
            if($page == "soft") {
                echo '<div class="breadcrumb_divider"></div> <a class="current">'.tr("MENU_CONFIG").'</a>';
                echo '<div class="breadcrumb_divider"></div> <a class="current">'.tr("GCONFIG_SOFTWARE_TITLE").'</a>';
            }
            ?>
        </article>