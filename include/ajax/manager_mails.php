...
$continue=true;
isset($_POST['hash'])?$hash=escape_string($_POST['hash']):$continue=false;
isset($_POST['list_id'])?$list_id=escape_string($_POST['list_id']):$continue=false;
isset($_POST['this_mail'])?$email=escape_string($_POST['this_mail']):$continue=false;
if ($continue) {
	switch($action){
		case 'delete':
